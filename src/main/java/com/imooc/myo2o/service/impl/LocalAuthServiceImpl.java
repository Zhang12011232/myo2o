		...
		try {
			...
			if (localAuth.getPersonInfo() != null
				...
				try {
					...
					System.out.println(personInfo.getProfileImg());
					System.out.println(personInfo.getEmail());
					System.out.println(personInfo.getAdminFlag());
					System.out.println(personInfo.getCreateTime());
					System.out.println(personInfo.getCustomerFlag());
					System.out.println(personInfo.getEnableStatus());
					System.out.println(personInfo.getShopOwnerFlag());
					...
					System.out.println("insert personinf");
