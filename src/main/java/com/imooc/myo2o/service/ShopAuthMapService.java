...
public interface ShopAuthMapService {
	...
	ShopAuthMapExecution addShopAuthMap(ShopAuthMap shopAuthMap)
			throws RuntimeException;
	ShopAuthMapExecution addShopAuthMap2(ShopAuthMap shopAuthMap,CommonsMultipartFile profileImg)
			throws RuntimeException;
	...
	ShopAuthMapExecution removeShopAuthMap(Long shopAuthMapId)
			throws RuntimeException;
	public ShopAuthMapExecution removeShopAuthMap2(Long shopAuthMapId,Long shopId)
			throws RuntimeException;
	/**
	 * 
	 * @param shopAuthId
